(function (window) {
    ...
    var Transitions = function () {
        ...
        this.easeCombined = function (startFunc, endFunc, ratio) {
            if (ratio < 0.5)
                return 0.5 * startFunc.call(basic.transitions, ratio * 2.0);
            else
                return 0.5 * endFunc.call(basic.transitions, (ratio - 0.5) * 2.0) + 0.5;
        }
    };
    window.basic.transitions = new Transitions();
})(window);